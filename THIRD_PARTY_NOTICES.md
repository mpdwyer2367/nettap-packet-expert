...
| Qwen3.5 9B Q4_K_M | `qwen3.5:9b-q4_K_M`, expected Ollama ID `6488c96fa5fa` | [Ollama model page](https://ollama.com/library/qwen3.5:9b-q4_K_M) and [upstream model card](https://huggingface.co/Qwen/Qwen3.5-9B) | Apache-2.0 model; initialization refuses a changed manifest identity |
