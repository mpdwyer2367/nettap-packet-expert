...
| Qwen3 8B | `qwen3:8b`, expected Ollama ID `500a1f067a9f` | [Ollama model page](https://ollama.com/library/qwen3:8b) | Apache-2.0 model; initialization refuses a changed manifest identity |
