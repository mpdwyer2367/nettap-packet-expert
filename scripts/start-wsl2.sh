...
echo "Local default login: admin@nettaptech.com / Password!"
echo "Immediately change the default password in Settings > Account."
echo "Then run ./scripts/finalize-admin.sh --confirm after verifying the default password fails."
