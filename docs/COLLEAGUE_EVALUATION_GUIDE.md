...
This is the shortest controlled macOS evaluation path for NetTAP Network Intelligence `0.3.0-rc.5`. It does not grant production or commercial approval.
...
4. Confirm `nettap-ai:0.3.0-rc.5` is the single NetTAP runtime model and both managed Workspace Model profiles were provisioned automatically.
