# Migration to the unified RC8 application

RC8 replaces separate launchers/profiles and the public Evidence Workspace with one assistant and one authenticated Open WebUI.
...
4. Check out the approved RC8 commit/package.
5. Run the platform start command. The installer builds `nettap-ai:0.3.0-rc.8`, provisions one assistant and retires recognized older NetTAP tags only after validation.
