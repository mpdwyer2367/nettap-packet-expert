...
> NetTAP Network Intelligence 0.3.0-rc.6 is a controlled-evaluation candidate for one shared model, two distinct Open WebUI profiles, validated evidence ingestion, deterministic case analysis, and a read-only Packet Expert evidence tool. It is not production-certified.
