...
Version `0.3.0-rc.7` has production-hardening and profile-isolation controls but has not completed production or commercial certification. See [the security boundary](docs/SECURITY.md), [threat model](docs/THREAT_MODEL.md), and [release gates](docs/COMMERCIAL_RELEASE_GATES.md).
