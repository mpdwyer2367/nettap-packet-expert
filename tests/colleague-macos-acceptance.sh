...
echo "1. On a fresh volume, sign in as admin@nettaptech.com with the documented local default."
echo "2. Change it, verify the default password fails, finalize activation, and verify the new password survives restart."
echo "3. Confirm signup is disabled and nettap-ai:0.4.0-rc.1 is the single NetTAP runtime model."
