...
echo "3. Confirm signup is disabled and both 0.3.0-rc.1 assistants are available in one model selector."
...
echo "6. Import each knowledge file and attach it only to its corresponding Workspace Model."
echo "7. Confirm knowledge isolation and that neither assistant claims unavailable live data."
