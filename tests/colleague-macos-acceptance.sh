...
[[ "$(uname -s)" == "Darwin" ]] || fail "This RC8 acceptance entry point requires macOS."
...
echo "1. On a fresh volume, sign in as admin@nettap.local with temporary password admin."
echo "2. Change the temporary password; verify the old password fails and the new password survives restart."
echo "3. Confirm signup is disabled and nettap-packet-expert:0.1.0-rc.8 is selected."
