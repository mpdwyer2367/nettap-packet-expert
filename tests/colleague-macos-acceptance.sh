...
echo "3. Confirm signup is disabled and nettap-packet-expert:latest is selected."
echo "4. Install the Open WebUI bundle and confirm all six packet-specialist prompts appear."
