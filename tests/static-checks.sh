...
grep -q 'Never advise emailing a packet capture' "$project_dir/model/Modelfile"
grep -q 'Counsel review required' "$project_dir/docs/LEGAL_AND_DATA_HANDLING.md"
grep -q 'NetTAP Confidential — Restricted Security Data' "$project_dir/docs/LEGAL_AND_DATA_HANDLING.md"
