...
grep -q '^OPEN_WEBUI_OLLAMA_BASE_URL=http://ollama:11434grep -q '^VISIBILITY_LAUNCHER_PORT=3000$' "$project_dir/.env.example"
grep -q '^PACKET_EXPERT_LAUNCHER_PORT=3001$' "$project_dir/.env.example"
grep -q '^EVIDENCE_PORT=3200$' "$project_dir/.env.example"
grep -q '^EVIDENCE_API_TOKEN=GENERATE_ON_FIRST_START$' "$project_dir/.env.example"
grep -Fqx '# NetTAP Network Intelligence' "$project_dir/README.md"
...
echo "Static checks passed."
 "$project_dir/.env.example"
grep -q 'ensure_env_default OPEN_WEBUI_OLLAMA_BASE_URL' "$project_dir/scripts/common.sh"
...
echo "Static checks passed."
 "$project_dir/.env.example"
grep -q '^OPEN_WEBUI_OLLAMA_BASE_URL=http://ollama:11434
grep -q '^PACKET_EXPERT_LAUNCHER_PORT=3001$' "$project_dir/.env.example"
grep -q '^EVIDENCE_PORT=3200$' "$project_dir/.env.example"
grep -q '^EVIDENCE_API_TOKEN=GENERATE_ON_FIRST_START$' "$project_dir/.env.example"
grep -Fqx '# NetTAP Network Intelligence' "$project_dir/README.md"
...
grep -q '^VISIBILITY_LAUNCHER_PORT=3000
grep -q '^PACKET_EXPERT_LAUNCHER_PORT=3001$' "$project_dir/.env.example"
grep -q '^EVIDENCE_PORT=3200$' "$project_dir/.env.example"
grep -q '^EVIDENCE_API_TOKEN=GENERATE_ON_FIRST_START$' "$project_dir/.env.example"
grep -Fqx '# NetTAP Network Intelligence' "$project_dir/README.md"
