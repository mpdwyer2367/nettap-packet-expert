...
$required = @('compose.yaml', '.env.example', 'model\Modelfile', 'scripts\Start-Windows.ps1', 'scripts\Windows-Common.ps1', 'docs\MACOS_DEPLOYMENT.md', 'docs\WINDOWS_DEPLOYMENT.md', 'workspace\install.py', 'workspace\skills\nettap-packet-evidence-analysis.md', 'tests\retrieval-e2e.sh')
