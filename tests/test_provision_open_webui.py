...
class OpenWebUIState:
    def __init__(self):
        ...
        self.skills = {}
        self.uploads = 0
        self.rag_marker = "NETTAP-RAG-OFFLINE-PROBE-RC5"
        self.config = {
            "DEFAULT_MODELS": "",
...
class ProvisioningTest(unittest.TestCase):
    ...
    def test_provisions_offline_rag_and_profiles_idempotently(self):
        ...
        for model in Handler.state.models.values():
            self.assertEqual(model["base_model_id"], "nettap-ai:0.3.0-rc.5")
        ...
        self.assertEqual(state["release_version"], "0.3.0-rc.5")
